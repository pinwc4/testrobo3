...
*/
    ...
    @Override
    public void stop() {
        Orientation t_navxAngles = robot.navxgyro.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
        DataStorage.finalAutoHeading = t_navxAngles.firstAngle;
    }
}
