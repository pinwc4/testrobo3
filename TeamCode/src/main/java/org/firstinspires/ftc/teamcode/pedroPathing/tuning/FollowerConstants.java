...
public class FollowerConstants {
    ...
    private static double xMovement = 98.44844;//81.34056;
    private static double yMovement = 78.94005;//65.43028;
    ...
    public static double forwardZeroPowerAcceleration = -44.28115;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -86.96994;
    ...
    public static double zeroPowerAccelerationMultiplier = 18;
