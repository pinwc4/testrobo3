...
public class FollowerConstants {
    ...
    private static double xMovement = 111.1111;//81.34056;
    private static double yMovement = 93.9111;//65.43028;
    ...
    public static double forwardZeroPowerAcceleration = -320;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -270;
