...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.138; // in; distance between the left and right wheels
    ...
    public static double X_MULTIPLIER = 0.9825; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.9825; // Multiplier in the Y direction
